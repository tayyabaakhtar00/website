    ...
    >
      ...
      <div className={`main-menu ${state.isSidebarOpen ? "show-menu" : ""}`}>
        ...
        <ul className="menu-list">
          <li className={`menu-item-has-children ${currentRoute === "/index4"?"active":""}`}>
            <a
              href="#"
              className={`drop-down ${
            ...
            >
              ...
              <li>
                <Link legacyBehavior href="/index4">
                  <a className={`menu-item-has-children ${currentRoute === "/index4"?"active":""}`}>Home 04</a>
                </Link>
              </li>
            </ul>
          </li>
          ...
          <li className={`menu-item-has-children ${currentRoute === "/service"?"active":""}`}>
            <a
              href="#"
              className={`drop-down ${
          ...
          <li className={`menu-item-has-children ${currentRoute === "/project"?"active":""}`}>
          ...
          <li className={`menu-item-has-children ${currentRoute === "/team1"?"active":""}`}>
            <a href="#" className="drop-down">
              Pages
            </a>
            <i
          ...
          <li className={`menu-item-has-children ${currentRoute === "/case-study"?"active":""}`}>
            <a
              href="#"
              className={`drop-down ${
          ...
          <li className={`menu-item-has-children ${currentRoute === "/blog"?"active":""}`}>
            <a
              href="#"
              className={`drop-down ${
      ...
      <div className="nav-right d-flex jsutify-content-end align-items-center">
        <div className="header-contact d-xl-block d-none">
          <span>
            <img src="assets/img/home-6/phone.svg" alt="" />
            For Client Support:
          </span>
          <h6>
            <a href="Tel:29658728617">2-965-871-8617</a>
          </h6>
        </div>
