        ...
        <div className="col-lg-4 col-sm-6 d-flex">
          <div className="footer-widget">
            <div className="footer-contact mb-40">
              ...
              <a href="#">RISQ 72 Dalston Kingsland Highstreet London,United Kindom</a>
            </div>
            <div className="footer-contact mb-40">
              <h4>
              ...
              <a href="mailto:info@support.com">info@support.com</a><br />
              <a href="mailto:contact@wcadlimited.com">contact@wcadlimited.com</a>
            </div>
          ...
          <div className="col-lg-12">
            <div className="footer-btn-content">
              <div className="copyright-area">
                <p>©Copyright 2023 <a href="#">WCAD</a> | Design By <a href="https://www.wcadlimited.com/">WCAD Developer</a></p>
              </div>
